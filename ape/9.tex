...
\begin{solution}
Si une coupe dans le graphe G comporte un nombre paire d'arête cela signifie que les cycles dans le graphe dual seront de longueur paire également. En effet une coupe dans le graphe G est l'équivalent du cycle enfermant une face dans le graphe dual. On a effectivement que toute les coupes dans G comporte un nombre paire d'arêtes car le nombre d'arête d'une coupe est le nombre d'arête d'une des partie déconnectée - le nombre d'arête interne à cette partie. Comme le nombre total des arêtes des noeuds d'une partie est paire car tout les noeuds sont de degré paire. On soustrait un nombre paire à un nombre paire et on a donc bien un graphe dual avec uniquement des cycles de degré paire. Si tout les cycle d'un graphe sont de degré paire il est biparti, si il est biparti il est coloriable en deux couleurs.
