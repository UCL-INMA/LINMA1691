...
Le théorème de Dirac affirme que si $\deg(v) > n/2$ pour tous les sommets $v \in V$ d'un graphe $G=(V,E)$, alors $G$ est hamiltonien. Donnez un graphe hamiltonien de $n$ sommets qui ne satisfait pas les conditions du théorème de Dirac. Donnez un graphe qui n'est pas hamiltonien et qui satisfait $\deg(v) \geq (n-1)/2$ pour tout $v \in V$.
...
\item Graphe non hamiltonien de 5 sommets satisfaisant $\deg(v) \geq (n-1)/2$ pour tout $v \in V$.\\
